...
namespace ProjetoFinalJulia.Controllers
{
    public class UsuarioController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,UsuarioNome,Email,Senha")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UsuarioNome,Email,Senha")] Usuario usuario)
        {
            if (id != usuario.Id)
            {
                return NotFound();
